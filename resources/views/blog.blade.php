...
<section class="blog blog-grid pb-90" id="blog">
    <div class="container">
        <div class="row">
            ...
            <div class=" col-sm-6 col-md-6 col-lg-4">
                <div class="blog-entry">
                    <div class="entry-img"><a href="blog-single.html"><img src="assets/images/blog/grid/4.jpg" alt="Changes to our Trade Credit Policy and Procedures " /></a></div>
                    <!-- End .entry-img-->
                    <!-- End .entry-date-->
                    <div class="entry-content">
                        <div class="entry-category"><a href="javascript:void(0)">news</a><a href="javascript:void(0)">industry</a>
                        </div>
                        <div class="entry-title">
                            <h4><a href="blog-single.html">Changes to our Trade Credit Policy and Procedures </a></h4>
                        </div>
                        <div class="entry-date"><span class="month">jan 20</span><span class="date">2021</span></div>
                        <div class="entry-bio">
                            <p>The Atradius platform will provide us with a much deeper pool of research to assist with assessment of new credit applications and credit limits...</p>
                        </div>
                        <div class="entry-more"> <a href="javascript:void(0)">Read more</a></div>
                    </div>
                </div>
            ...
            <div class=" col-sm-6 col-md-6 col-lg-4">
                <div class="blog-entry">
                    <div class="entry-img"><a href="blog-single.html"><img src="assets/images/blog/grid/5.jpg" alt="New Additions to our great Metro trucks Fleet " /></a></div>
                    <!-- End .entry-img-->
                    <!-- End .entry-date-->
                    <div class="entry-content">
                        <div class="entry-category"><a href="javascript:void(0)">insights</a><a href="javascript:void(0)">industry</a>
                        </div>
                        <div class="entry-title">
                        ...
                        <div class="entry-date"><span class="month">jan 23</span><span class="date">2021</span></div>
                        <div class="entry-bio">
                            <p>These new vehicles are all extra high trucks, with a height equal to that of a trailer. This allows us to accommodate our clients with high freight...</p>
                        </div>
                        <div class="entry-more"> <a href="javascript:void(0)">Read more</a></div>
                    </div>
                </div>
            ...
            <div class=" col-sm-6 col-md-6 col-lg-4">
                <div class="blog-entry">
                    <div class="entry-img"><a href="blog-single.html"><img src="assets/images/blog/grid/6.jpg" alt="The new Driver Training &amp; Recruitment Program " /></a></div>
                    <!-- End .entry-img-->
                    <!-- End .entry-date-->
                    <div class="entry-content">
                        <div class="entry-category"><a href="javascript:void(0)">news</a><a href="javascript:void(0)">logistics</a>
                        </div>
                        <div class="entry-title">
                            <h4><a href="blog-single.html">The new Driver Training &amp; Recruitment Program </a></h4>
                        </div>
                        <div class="entry-date"><span class="month">jan 24</span><span class="date">2021</span></div>
                        <div class="entry-bio">
                            <p>If you know of anyone looking for a bigger opportunity, a fresh start, or just something different, please have them contact our operations team now...</p>
                        </div>
                        <div class="entry-more"> <a href="javascript:void(0)">Read more</a></div>
                    </div>
                </div>
